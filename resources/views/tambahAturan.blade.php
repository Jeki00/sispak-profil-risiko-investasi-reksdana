        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="/aturan/tambah" method="POST">
                        @csrf
                        <label for="inputProfil" class="form-label">Profil</label>
                        <select name="profil" id="inputProfil" class="form-control">
                        ...
                        <div id="inputJawaban1" class="form-control">
                        ...
                        <div id="inputJawaban2" class="form-control">
                        ...
                        <div id="inputJawaban3" class="form-control">
                        ...
                        <div id="inputJawaban4" class="form-control">
